...
def main(FLAGS, UNPARSED_ARGV):
    ...
    model = models.__dict__.get(FLAGS.model)(FLAGS.num_layers, FLAGS.num_channels, num_degrees=FLAGS.num_degrees,
                                             ...
                                             out_dim=FLAGS.out_dim, num_class=FLAGS.num_class,
                                             batch=FLAGS.batch_size, num_points=FLAGS.num_points)


    # Save path
    save_path = os.path.join(FLAGS.save_dir, f'{FLAGS.name}_{FLAGS.num_points}_{FLAGS.num_random}_{FLAGS.antithetic}_backuped' + '.pt')
...
if __name__ == '__main__':
    ...
    name = f'Golden_{FLAGS.num_points}_{FLAGS.num_random}_{FLAGS.data_str}_{FLAGS.batch_size}_{FLAGS.head}_{FLAGS.num_channels}\
                            _{FLAGS.num_layers}'
